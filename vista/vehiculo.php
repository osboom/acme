				...
				<article class="my-5 pt-5" id="tables">
      				<div>
        				<div class="bd-example">
							<h2 class="text-center">Listar Vehiculos</h2>
							<p align="right">
        					...
        					<table class="table table-striped">
          						<thead>
          							<tr>
										<th scope="col"><i class="fa fa-id-card p-1"></i>Placa</th>
										<th scope="col"><i class="fa fa-user p-1"></i>Color</th>
										<th scope="col"><i class="fa fa-phone-alt p-1"></i>Marca</th>
										<th scope="col"><i class="fas fa-suitcase p-1"></i>Tipo</th> 
										<th scope="col"><i class="fas fa-suitcase p-1"></i>Carga</th>
										<th scope="col"><i class="fas fa-suitcase p-1"></i>peso</th>
